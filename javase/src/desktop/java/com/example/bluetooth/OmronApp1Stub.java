 ...
 * @author Shai Almog
 */
public class OmronApp1Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "OmronApp1";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new OmronApp1Stub());
    }
